  ...
  if (localStorage.getItem('theme') === 'dark') {
    ...
    document.getElementById('themeToggle').innerHTML = '<i class="mdi mdi-white-balance-sunny"></i>';
  }
  ...
  document.getElementById('themeToggle').addEventListener('click', function () {
    ...
    if (document.body.classList.contains('dark-mode')) {
      ...
      this.innerHTML = '<i class="mdi mdi-white-balance-sunny"></i>'; // Light icon
    } else {
      localStorage.setItem('theme', 'light');
      this.innerHTML = '<i class="mdi mdi-weather-night"></i>'; // Dark icon
    }
  });
